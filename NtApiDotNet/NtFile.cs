...
namespace NtApiDotNet {
  ...
  public class NtFile : NtObjectWithDuplicateAndInfo<NtFile, FileAccessRights, FileInformationClass, FileInformationClass> {
    ...
    public NtStatus SetCreationTime(DateTime time, bool throw_on_error) {
      return SetBasicInformation(new FileBasicInformation() { CreationTime = time.ToLargeIntegerStruct() }, throw_on_error);
    }
    ...
    public NtStatus SetLastAccessTime(DateTime time, bool throw_on_error) {
      return SetBasicInformation(new FileBasicInformation() { LastAccessTime = time.ToLargeIntegerStruct() }, throw_on_error);
    }
    ...
    public NtStatus SetLastWriteTime(DateTime time, bool throw_on_error) {
      return SetBasicInformation(new FileBasicInformation() { LastWriteTime = time.ToLargeIntegerStruct() }, throw_on_error);
    }
    ...
    public NtStatus SetChangeTime(DateTime time, bool throw_on_error) {
      return SetBasicInformation(new FileBasicInformation() { ChangeTime = time.ToLargeIntegerStruct() }, throw_on_error);
    }

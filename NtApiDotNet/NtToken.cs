...
namespace NtApiDotNet {
  ...
  public sealed class NtToken : NtObjectWithDuplicateAndInfo<NtToken, TokenAccessRights, TokenInformationClass, TokenInformationClass> {
    ...
    public byte[] AuditPolicy {
      get => Query<TokenAuditPolicy>(TokenInformationClass.TokenAuditPolicy).PerUserPolicy;
    ...
    /// </summary>
    public static Luid LocalSystemAuthId => new Luid(0x3e7, 0);
    /// <summary>
    /// Get authentication ID for LOCAL SERVICE
    /// </summary>
    public static Luid LocalServiceAuthId => new Luid(0x3e5, 0);
    /// <summary>
    /// Get authentication ID for NETWORK SERVICE
    /// </summary>
    public static Luid NetworkServiceAuthId => new Luid(0x3e4, 0);
    /// <summary>
    /// Get authentication ID for ANONYMOUS
    /// </summary>
    public static Luid AnonymousAuthId => new Luid(0x3e6, 0);

    /// <summary>
    /// Get a pseudo handle to the primary token.
    /// </summary>
    /// <remarks>Only useful for querying information.</remarks>
    public static NtToken PseudoPrimaryToken => GetPseudoToken(-4);
    /// <summary>
    /// Get a pseudo handle to the impersonation token.
    /// </summary>
    /// <remarks>Only useful for querying information.</remarks>
    public static NtToken PseudoImpersonationToken => GetPseudoToken(-5);
    /// <summary>
    /// Get a pseudo handle to the effective token.
    /// </summary>
    /// <remarks>Only useful for querying information.</remarks>
    public static NtToken PseudoEffectiveToken => GetPseudoToken(-6);

...
namespace NtApiDotNet {
  ...
  public abstract class NtObject : IDisposable {
    ...
    /// <param name="throw_on_error">True to throw on error.</param>
    /// <returns>The NT status code.</returns>
    public NtStatus MakeTemporary(bool throw_on_error) {
      return NtSystemCalls.NtMakeTemporaryObject(Handle).ToNtException(throw_on_error);
    }
    ...
    /// <param name="throw_on_error">True to throw on error.</param>
    /// <returns>The NT status code.</returns>
    public NtStatus MakePermanent(bool throw_on_error) {
      return NtSystemCalls.NtMakePermanentObject(Handle).ToNtException(throw_on_error);
    }

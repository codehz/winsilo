...
namespace NtApiDotNet {
  ...
  public class NtIoCompletion : NtObjectWithDuplicateAndInfo<NtIoCompletion, IoCompletionAccessRights, IoCompletionInformationClass, IoCompletionInformationClass> {
    ...
    public static NtResult<NtIoCompletion> Create(ObjectAttributes object_attributes, IoCompletionAccessRights desired_access, int concurrent_threads, bool throw_on_error) {
      return NtSystemCalls.NtCreateIoCompletion(out SafeKernelObjectHandle handle, desired_access, object_attributes, concurrent_threads).CreateResult(throw_on_error, () => new NtIoCompletion(handle));
    }
    ...
    public static NtResult<NtIoCompletion> Open(ObjectAttributes object_attributes, IoCompletionAccessRights desired_access, bool throw_on_error) {
      return NtSystemCalls.NtOpenIoCompletion(out SafeKernelObjectHandle handle, desired_access, object_attributes).CreateResult(throw_on_error, () => new NtIoCompletion(handle));
    }
    ...
    /// </summary>
    public int Depth => Query<IoCompletionBasicInformation>(IoCompletionInformationClass.IoCompletionBasicInformation).Depth;
    #endregion
  }
}

...
namespace NtApiDotNet {
  ...
  public class NtThread : NtObjectWithDuplicateAndInfo<NtThread, ThreadAccessRights, ThreadInformationClass, ThreadInformationClass> {
    ...
    public static NtThread Current => new NtThread(new SafeKernelObjectHandle(-2));
    ...
    public string Description {
      ...
      set => Set(ThreadInformationClass.ThreadNameInformation, new UnicodeStringIn(value));
    }
